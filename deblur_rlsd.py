...
src_params = {}
src_params['source_FWHM_x_axis'] = 2.59 #Full width half maximum (FWHM) along x-axis (row-wise)
src_params['source_FWHM_y_axis'] = 2.96 #FWHM along y-axis (column-wise)
...
det_params = {}
det_params['detector_FWHM_1'] = 1.98 #FWHM of first exponential
det_params['detector_FWHM_2'] = 127.07 #FWHM of second exponential
